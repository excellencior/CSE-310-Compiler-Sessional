...
void handleFunctionDefinition(string funcName, string funcReturnType, vector<SymbolInfo*> definedFuncParamList) {
	...
	if (success == false) {
		...
		cout << "Defined Func Type: " << symbol->getDataType() << ", Declared func type: " << funcReturnType << " Line: " << lineCount << endl;
...
func_declaration : type_specifier ID LPAREN parameter_list RPAREN SEMICOLON { // void fun(int a, int b) => type_specifier ID(int a COMMA int b) SEMICOLON
				...
				$$ = new SymbolInfo("func_declaration", $1->getStype(), $1->getDataType(),  "NON-TERMINAL");
...
func_definition : type_specifier ID LPAREN parameter_list RPAREN {handleFunctionDefinition($2->getSname(), $1->getSname(), $4->getParameterList());} compound_statement {
				...
				$$ = new SymbolInfo("func_definition", $1->getStype(), $1->getDataType(),  "NON-TERMINAL");
...
parameter_list  : parameter_list COMMA type_specifier ID { // void func(int a, int b, float c)
				...
				$$ = new SymbolInfo("parameter_list", $1->getStype(), $1->getDataType(),  "NON-TERMINAL");
...
compound_statement : LCURL {symbolTable.EnterScope();addParametersToFunctionDefinition();} statements RCURL {
		...
		// int z(int d) { return d; } => To catch and insert d into the current scope of the symbol table
				...
				$$ = new SymbolInfo("compound_statement", $1->getStype(), $1->getDataType(),  "NON-TERMINAL");
...
var_declaration : type_specifier declaration_list SEMICOLON {
				...
				$$ = new SymbolInfo("var_declaration", $1->getStype(), $1->getDataType(),  "NON-TERMINAL");
				...
				if (symbolTable.getCurrentScopeNum() == 1) {
					for (SymbolInfo* si: $2->getDeclarationList()) {
						si->setGlobalVar(true);
						globalVariableList.push_back(si);
					}
				}
...
declaration_list : declaration_list COMMA ID {
				...
				// $$ = $1;
				$$ = new SymbolInfo("declaration_list", $1->getStype(), $1->getDataType(),  "NON-TERMINAL");
...
statements : statement {
                ...
                $$ = new SymbolInfo("statements", $1->getStype(), $1->getDataType(),  "NON-TERMINAL");
...
statement : var_declaration {
                ...
                $$ = new SymbolInfo("statement", $1->getStype(), $1->getDataType(),  "NON-TERMINAL");
...
expression_statement : SEMICOLON {
                ...
                $$ = new SymbolInfo("expression_statement", $1->getStype(), $1->getDataType(),  "NON-TERMINAL");
...
variable : ID {
				...
				$$ = new SymbolInfo("variable", $1->getStype(), $1->getDataType(),  "NON-TERMINAL");
...
expression : logic_expression {
				...
				$$ = new SymbolInfo("expression", $1->getStype(), $1->getDataType(),  "NON-TERMINAL");
	   ...
	   | variable ASSIGNOP logic_expression {
				...
				$$ = new SymbolInfo("expression", $1->getStype(), $3->getDataType(),  "NON-TERMINAL");
...
logic_expression : rel_expression {
				...
				$$ = new SymbolInfo("logic_expression", $1->getStype(), $1->getDataType(),  "NON-TERMINAL");
...
rel_expression	: simple_expression {
				...
				$$ = new SymbolInfo("rel_expression", $1->getStype(), $1->getDataType(),  "NON-TERMINAL");
...
simple_expression : term {
				...
				$$ = new SymbolInfo("simple_expression", $1->getStype(), $1->getDataType(),  "NON-TERMINAL");
...
term :	unary_expression {
				...
				$$ = new SymbolInfo("term", $1->getStype(), $1->getDataType(),  "NON-TERMINAL");
...
unary_expression : ADDOP unary_expression  {
				...
				$$ = new SymbolInfo("unary_expression", $2->getStype(), $2->getDataType(),  "NON-TERMINAL");
		 ...
		 | factor {
				...
				$$ = new SymbolInfo("unary_expression", $1->getStype(), $1->getDataType(),  "NON-TERMINAL");
...
factor	: variable {
				...
				$$ = new SymbolInfo("factor", $1->getStype(), $1->getDataType(),  "NON-TERMINAL");
...
argument_list : arguments {
				...
				$$ = new SymbolInfo("argument_list", $1->getStype(), $1->getDataType(),  "NON-TERMINAL");
...
arguments : arguments COMMA logic_expression {
				...
				$$ = new SymbolInfo("arguments", $1->getStype(), $1->getDataType(),  "NON-TERMINAL");
